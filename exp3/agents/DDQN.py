...
class DDQN:
    ...
    def createNN(self, input_type):
        ...
        value_net = MLPCritic(layer_dims=layer_dims, hidden_act=self.cfg['hidden_act'],
                              output_act=self.cfg['output_act'], last_w_scale=1.0)
    ...
    def time_to_learn(self):
        ...
        """
        if self.step_count > self.cfg['exploration_steps'] and self.step_count % self.cfg[
            'network_update_frequency'] == 0:
            return True
        else:
            return False
